...
//!
//! The reference loads with `cv2.imread` and its test script divides by 255,
//! runs the network and clamps to [0,1] before writing - the same float
//! pipeline this module implements, on the host side of the boundary.
use std::fs::File;
